...
<div class="container">
    ...
    <div class="card col-md-2 lside" >
        <table class="menu" style="color:black;"  >
            <tr >
                <td class="propic" >
                    <?php echo "<img src='images/profilepic/$profile_pic' width='100%;' height='200px;'>";?>
                </td>
            </tr>
            <tr class="tbrow" >
                <td class="tbrowsub">
            ...
            <tr class="tbrow">
                <td class="tbrowsub">
                    <a class="menulink" href="unreadmessages.php"><h3>Messages <i class="iconmenu fa fa-file-text"></i></h3></a>
                </td>
            </tr>
            <tr class="tbrow">
                <td class="tbrowsub">
    ...
    <!--Beginning of post area -->
        <div class=" card container status" style="width:100%;background-color:white;">
            <h4>Status</h4>
            <form action="post.php" method="POST">
                <div class="form-group">
                    <textarea class="form-control"  placeholder="What's on your mind....." name="posttext" required></textarea>
                </div>
    ...
    <!--Beginning of post display area -->
        <div class="container post" style="width:100%; padding:15px;">
