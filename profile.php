...
echo "<script>alert('No Person Found');window.location='member.php';</script>";
$row=mysqli_fetch_array($result);
$name=$row['name'];
$profile_pic=$row['profile_pic'];
$query1="SELECT * FROM messages WHERE reciever_id='$uid1' AND read_status='no'";
...
<div class="container">
    ...
    <div class="card col-md-2 lside" >
        <table class="menu" style="color:black;"  >
            ...
            <tr class="tbrow">
                <td class="tbrowsub">
                    <a class="menulink" href="profile.php?uid=<?php echo $_SESSION['uid'] ?>"><h3>Profile<i class="iconmenu fa fa-drivers-license"></i></h3></a>
                </td>
            </tr>
            <tr class="tbrow">
                <td class="tbrowsub">
    ...
    <!--Beginning of post display area -->
        <div class="container post" style="width:100%; padding:15px;">
            <?php include "includes/getpostprofile.php" ?>
        </div>
